...
insert  into `pm_sysblacklist`(`id`,`platform`,`user_id`,`user_name`,`lock_time`,`memo`,`status`,`release_id`,`release_user`,`release_time`,`lock_id`,`lock_user`) values (15,'aff',10,'wyt25',1273938287,'该站长作弊，暂时屏蔽！',0,0,'',0,7,'admin'),(16,'aff',9,'392152287',1273938287,'该站长作弊，暂时屏蔽！',0,0,'',0,7,'admin');
