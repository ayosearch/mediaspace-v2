...
write("<table border='0' bgcolor='#cccccc' noWrap'>");
write("<TR>");
...
write("<DIV style='background-color:#DADAE7'><table width='100%' border='0'>");
fDrawCal(giYear, giMonth, 20, '12');
write("</table></DIV>");
write("</td>");
write("</TR><TR><TD align='center'>");
write("<TABLE width='100%'><TR><TD align='center' noWrap>");
...
write("</td><td algin='center' noWrap>");
...
function modify_ms(fjid){
	//alert ('f');
	window.open('modify_xm.asp?fjid='+fjid,'xmmodify','left=260,top=30,width=350,height=450,Status=no,scrollbars=no,resizable=no')
}
