...
function toStdAmount(sAmount)
{
	...
	var toMatchNaNum = /\D/;
	if ((iDotIndex!=-1&&iLength-iDotIndex>5)
...
function getChineseCurrencyString(sAmount)
{
	...
	var corn = new Array('0','0','0');			
	var cornunit = new Array('角', '分', '厘');
	...
	for (i = 0; i < corn.length; i++)
	{
		...
		if (i==2&&curchar!='0') result = result+dig+cornunit[2];
	}
